...
sr.reveal('.home-data, .about-container-img, .skills-subtitle, .skills-text',{}); 
sr.reveal('.home-img, .about-container-data, .about-buttons, .skills-img',{delay: 400}); 
sr.reveal('.home-social-icon',{ interval: 200}); 
sr.reveal('.qualification-container , .portfolio-container, .services-container',{interval: 200}); 

sr.reveal('.skills-data, .skills-container, .work-img, .contact-container',{interval: 200}); 